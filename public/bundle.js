...
/***/ function(module, exports, __webpack_require__) {
	...
	var io = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(206)('socket.io-client');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(206)('socket.io-client:url');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(206)('socket.io-client:manager');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var on = __webpack_require__(248);
	var bind = __webpack_require__(249);
	var debug = __webpack_require__(206)('socket.io-client:socket');
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        Display,
	                        { 'if': this.props.currentQuestion },
	                        React.createElement(Ask, { emit: this.props.emit, question: this.props.currentQuestion })
	                    )
	                ),
	                React.createElement(
	                    Display,
	...
	var JoinSpeaker = React.createClass({
	    ...
	    render() {
	        return React.createElement(
	            ...
	            React.createElement('input', { ref: 'title', className: 'form-control',
	    ...
	    render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'p',
	                null,
	                'We cannot find the page that you have requested Were you lookin one of these: '
	            ),
	            React.createElement(
	                Link,
	                { to: '/' },
	            ...
	            React.createElement(
	                Link,
	                { to: '/speaker' },
	                'Join as Speaker. Start the presentation!'
	            ),
	            React.createElement(
	                Link,
	                { to: '/board' },
